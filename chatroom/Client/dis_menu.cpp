...
void help_dis()
{
    printf("\033[5;14H           ＊ 谢谢使用GP_ONLINE聊天室＊      \n");
    usleep(SIZE);
    ...
    usleep(SIZE);
    printf("\033[11;14H       你还可以加入GP_ONLINE会员             \n");
    usleep(SIZE);
    ...
    usleep(SIZE);
    printf("\033[15;14H                 GP_ONLINE V3.0              \n");
    sleep(6);
    printf("\033[5;14H                                             \n");
    printf("\033[6;14H                                             \n");
    printf("\033[7;14H                                             \n");
...
void reg_dis()
{
    ...
    printf("\033[6;38H｜^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^｜\n");
    usleep(LOGSLEEP);
    printf("\033[7;38H｜＊                  欢迎注册GP_ONLINE                 ＊｜\n");
    usleep(LOGSLEEP);
    printf("\033[8;38H｜                                                        ｜\n");
    usleep(LOGSLEEP);
...
void rem_passwd()
{
    ...
    printf("\033[8;45H｜^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^｜\n");
    usleep(LOGSLEEP);
    printf("\033[9;45H｜^^^^^^^^        GP_ONLINE         ^^^^^^^^｜\n");
    usleep(LOGSLEEP);
    printf("\033[10;45H｜               安全服务中心               ｜\n");
    usleep(LOGSLEEP);
    printf("\033[11;45H｜                                          ｜\n");
    usleep(LOGSLEEP);
    printf("\033[12;45H｜     请输入你的GP号                       ｜\n");
    usleep(LOGSLEEP);
...
void user_dis()
{
    ...
    printf("\033[4;12H｜^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^｜   GP_NEWS……    ｜ ｜     ｜   NAME:                   ｜\n");
    printf("\033[5;12H｜                                                   ｜                ｜ ｜(^_^)｜                           ｜\n");
    printf("\033[6;12H｜                                                   ｜                ｜ ｜_____｜   GPID:        赞:        ｜\n");
    printf("\033[7;12H｜                                                   ｜                ｜                                    ｜\n");
    printf("\033[8;12H｜                                                   ｜                ｜ 个性签名: 这个人很懒,什么都没留下       ｜\n");
    printf("\033[9;12H｜                                                   ｜                  ＊－－－－－－－－－－－－－－－－－－＊\n");
   printf("\033[10;12H｜                                                   ｜                 ｜                                    ｜\n");
   printf("\033[11;12H｜                                                   ｜                 ｜                                    ｜\n");
   printf("\033[12;12H｜                                                   ｜                 ｜                                    ｜\n");
   ...
   printf("\033[17;12H＊                                                   ＊                 ｜                                    ｜\n");
   printf("\033[18;12H｜  隐藏功能:仅GP会员(超级用户)可见.VIP专用               ｜                 ｜                                    ｜\n");
   printf("\033[19;12H＊___________________________________________________＊                 ＊____________________________________＊\n");
   printf("\033[20;12H｜                                                   ｜                ｜                                    ｜\n");
   printf("\033[21;12H｜   ＊群聊(ACH)     ＊私聊(PCH)     ＊点赞(ZAN)        ｜                ｜＊刷出在线好友(DIS)  ＊GP简介(HLP)  ｜\n");
   printf("\033[22;12H｜                                                   ｜                ｜                                    ｜\n");
...
void superuser_dis()
{
    ...
    printf("\033[4;12H｜^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^｜   GP_NEWS……    ｜ ｜     ｜   NAME:                  ｜\n");
    printf("\033[5;12H｜                                                   ｜                ｜ ｜(^_^)｜                          ｜\n");
    printf("\033[6;12H｜                                                   ｜    今日天气     ｜ ｜_____｜   GPID:        赞:       ｜\n");
    printf("\033[7;12H｜                                                   ｜                ｜                                    ｜\n");
